var loginButton = document.getElementById("login-btn"); // Hagamos que el botón LOG IN nos lleve a nuestra nueva página LOGIN.JSP
...
var _a, _b;
// Bongo Cat fue originalmente creado por @StrayRogue y @DitzyFlama.
const ID = "bongo-cat";
...
// La escritura de la función "pipe" no parece funcionar cuando se utiliza parcialmente aplicada.
